...
class InputHandler {
  ...
  printHelp() {
    ...
    console.log('/setup           Show the BlackHole setup and readiness steps');
    console.log('/voices          List available macOS voices');
    console.log('/outputs         List available output devices');
    console.log('/doctor          Inspect audio visibility and BlackHole driver state');
    console.log('/status          Show the current settings');
    console.log('/exit            Quit the application');
  }

  printSetup() {
    console.log('BlackHole setup:');
